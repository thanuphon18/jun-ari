  ...
  if (!order) {
    return (
      <div className="py-10 text-center text-muted-foreground">
        Order not found. <Link href="/account" className="text-primary hover:underline">Go back</Link>
      </div>
    )
  }
                ...
                return (
                  <div key={step.key} className="flex flex-1 flex-col items-center">
                    <div className="flex w-full items-center">
                      {i > 0 && (
                        <div className={cn("h-0.5 flex-1", i <= currentStep ? "bg-primary" : "bg-border")} />
                      )}
                      <div
                        className={cn(
                    ...
                    <span className={cn("mt-2 text-xs", done ? "font-medium text-foreground" : "text-muted-foreground")}>
                      {step.label}
                    </span>
                  </div>
                )
